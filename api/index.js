...
// Jalur tes (biar kalau dibuka di browser tidak memunculkan eror 500 lagi)
app.get('/', (req, res) => {
    res.send('Server Anime AI Kawaguchi01 Berhasil Berjalan dengan Normal!');
});

// Jalur utama (Endpoint) untuk menerima chat dari aplikasi HP
...
// Wajib diekspor agar dibaca oleh sistem Serverless Vercel
module.exports = app;
